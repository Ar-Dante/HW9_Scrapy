...
class MainSpider(scrapy.Spider):
    ...
    def parse_author(self, response, *args):
        ...
        author_name = content.xpath("h3[@class='author-title']/text()").get().strip()
        ...
        yield AuthorItem(author_name=author_name, date_born=date_born, born_location=born_location, bio=bio)
